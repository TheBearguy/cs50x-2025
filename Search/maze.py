...
#             raise Exception("must have exactly one starting point")
#         if contents.count("B") != 1:
#             raise Exception("must have exactly one ending point")
...
#         # Keep a track of the number of nodes explored:
#         self.num_explored = 0
